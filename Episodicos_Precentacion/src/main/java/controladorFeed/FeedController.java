...
// <editor-fold defaultstate="collapsed" desc="HttpServlet methods. Click on the + sign on the left to edit the code.">
     ...
     protected void doGet(HttpServletRequest request, HttpServletResponse response)
          ...
          List<Serie> series = serieBean.buscarTodas();  // Cambiar a tu método para obtener todas las series
          List<Comun> posts = comunBean.buscarTodos();   // Cambiar a tu método para obtener todos los posts

          // Pasar las listas al JSP
          request.setAttribute("series", series);
          request.setAttribute("posts", posts);

          // Redirigir al JSP de Feed
