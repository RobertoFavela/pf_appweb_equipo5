                                ...
                                <c:forEach var="post" items="${posts}">
                                    ...
                                    <div class="resena ">
                                        ...
                                        <div class="texto-resena">
                                            <p>${post.contenido}</p>
                                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione corporis
                                                fuga corrupti maxime excepturi iure repellat ducimus quaerat deleniti!
                                                Voluptatum saepe aspernatur quia earum illo quaerat expedita beatae
                                                adipisci eveniet amet? Veniam quod quibusdam debitis distinctio, ea vero
                                                asperiores praesentium fugiat, perferendis corrupti placeat iure ducimus
                                                amet accusantium exercitationem nostrum expedita culpa perspiciatis
                                                natus facere quasi consequatur harum! Dolor veniam ex fugit odit
                                                voluptatibus laudantium consequuntur cum culpa, dignissimos ut in
                                                mollitia aut aliquam debitis laboriosam. Repellendus iure officiis
                                                error? Minus doloribus tempora id doloremque iste, dolor unde
                                                perferendis ab. Eligendi libero vitae corrupti tempore incidunt
                                                explicabo? In, amet voluptatum?</p>


                                        </div>
                                        <form action="" method="post">
                                            <c:if test="${esAdmin}"></c:if>
