        ...
        <div class="Feed">
            ...
            <section class="gestionar-serie">
                ...
                <form id="form-serie" class="form-serie" action="GestionSerieController" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" id="nom" name="nombre" placeholder="Ej: Stranger Things" required>

                    <div id="extras">
                        <label for="descripcion">Descripción:</label>
                        <textarea id="des" name="descripcion" placeholder="Agrega una breve descripción..." rows="5" required></textarea>

                        <label for="genero">Género:</label>
                        <select id="gen" name="genero" required>
                        ...
                        <input type="date" id="lan" name="lanzamiento" min="1900" max="2100" required>

                        <label for="portada">Imagen de Portada:</label>
                        <input type="file" id="por" name="portada" accept="image/*" required>
                    </div>
